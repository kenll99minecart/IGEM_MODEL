...
EnvZ=[12 20 18 21 23 23 23 25 30 30 41 58 72 82 83 85 95 90 ]';
EnvZ=((1-(EnvZ./100)).*4);
...
[lsbeta2, resnorm, residual, exitflag, output, lambda, jacobian] =lsqcurvefit(modelfunc1, beta1, tt, EnvZ,[0,0,0],[100,100,100]); %V2
...
%  figure(1);
 ...
 hold off;
 constfuncT(tf, lsbeta2, sodium, 1);  % plot the model curve with the fitted parameters
 hold on;
 plot(x2(1:end-9,2).*60, EnvZ, 'kx');  % add the data points to the plot
% figure(1)
